...
def deploy():
    '''
    A function that calls the do_pack and do_deploy function.
    '''
    call_do_pack = do_pack()
    if call_do_pack is None:
        return False

    call_do_deploy = do_deploy(call_do_pack)

    return call_do_deploy
